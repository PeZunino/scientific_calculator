...
MainInput = Entry(root, width=35, borderwidth=5, font=Font_tuple)
...
add_button = Button(root, text="   +   ", padx=40, pady=20, command=handle_add_button, font=Font_tuple)
subtract_button = Button(root, text="   -   ", padx=42, pady=22, command=handle_subtract_button, font=Font_tuple)
divide_button = Button(root, text="   /   ", padx=40, pady=20, command=handle_divide_button, font=Font_tuple)
multiply_button = Button(root, text="   *   ", padx=41, pady=21, command=handle_multiply_button, font=Font_tuple)
equal_button = Button(root, text="   =   ", padx=40, pady=20, command=handle_equal, font=Font_tuple)
